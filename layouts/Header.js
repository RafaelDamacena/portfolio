...
const Header = () => {
  const menus = [
    { id: 1, title: "Início", href: "home", icon: "fa fa-home" },
    { id: 2, title: "Sobre", href: "about", icon: "fa fa-user" },
    { id: 3, title: "Portfólio", href: "portfolio", icon: "fa fa-briefcase" },
    { id: 4, title: "Contato", href: "contact", icon: "fa fa-envelope-open" },
  ];
