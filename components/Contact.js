...
const Contact = () => {
  ...
  const onSubmit = (e) => {
    ...
    if (
      ...
      emailjs
        .send(
          "service_ku33ueh", // service id
          "template_6rypbdv", // template id
          mailData,
          "EF6YIVf7f6gyQ3xaq" // public api
        )
        .then(
          (response) => {
            setError(false);
          ...
          <div className="flex down-lg:flex-col">
            ...
            <div className="w-1/3 down-lg:w-full px-16 xs:px-0">
              ...
              <p className="mb-16 font-Open-sans text-fs-15 xs:text-fs-14">
                Se sinta livre para entrar em contato comigo! Podemos conversar sobre 
                seus projetos e suas ideias mais criativas e coloca-las em prática!
              </p>
